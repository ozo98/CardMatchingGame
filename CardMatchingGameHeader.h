...
cout << "                   Hard : 100초 " << endl;\
cout << "       겁나 어려움 개발자도 2번밖에 클리어못함" << endl<<endl<<endl;\
cout << "######### w : 위 #### s : 아래 #### f : 시작 ########"
...
enum class GAMESTATE { INIT, READY, LEVELSELECTION, OPENCARD, RUNNING, STOP, SUCCESS, FAIL, RESULT, CLOSEGAME };
...
public:
	GameManager() : _alphabet_list(), _card_list(), _check_list(), _level(LEVELSTATE::LEVEL1),
		leftTime(0), firstTime(0), _checkCount(0), _status(GAMESTATE::INIT), curXPos(1), curYPos(1), point(0) {}
